...
export default function SettingsPage() {
  ...
  const handleUpdateSetting = async <K extends keyof BatchSettings>(
    key: K,
    ...
    <>
      ...
      <div className="border rounded-xl bg-card border-border/80 p-5 flex flex-col gap-5 text-xs text-foreground">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex flex-col gap-1.5">
              ...
              <Select
                ...
                onValueChange={(val) =>
                  handleUpdateSetting("defaultOutputType", val as OutputType)
                }
              >
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <Select
                ...
                onValueChange={(val) =>
                  handleUpdateSetting("defaultQuality", val)
                }
              >
                <SelectTrigger className="h-9 text-xs bg-background">
          ...
          <div className="flex flex-col gap-1.5">
            <Label className="text-[11px] text-muted-foreground uppercase font-semibold">
              {t("defaultFilenameTemplate")}
            </Label>
            <Input
              value={settings.filenameTemplate}
              onChange={(e) =>
                handleUpdateSetting("filenameTemplate", e.target.value)
              }
            ...
            <span className="text-[10px] text-muted-foreground leading-relaxed mt-0.5">
              ...
              ,{" "}
              <code className="bg-background px-1 py-0.5 rounded">{`{platform}`}</code>
              ,{" "}
              <code className="bg-background px-1 py-0.5 rounded">{`{quality}`}</code>
              ,{" "}
              <code className="bg-background px-1 py-0.5 rounded">{`{date}`}</code>
            </span>
          </div>
        </div>
            ...
            <div className="flex items-center gap-3 overflow-hidden">
              ...
              <div className="flex flex-col min-w-0">
                <span className="text-xs font-bold text-foreground truncate">
                  {customDirName
                    ? t("customDirName", { name: customDirName })
                    : t("browserDefaultDir")}
                </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="flex flex-col gap-1.5">
              ...
              <Select
                ...
                onValueChange={(val) =>
                  handleUpdateSetting("parseConcurrency", parseInt(val, 10))
                }
              >
                <SelectTrigger className="h-9 text-xs bg-background">
            ...
            <div className="flex flex-col gap-1.5">
              <Label className="text-[11px] text-muted-foreground uppercase font-semibold">
                {t("downloadConcurrency")}
              </Label>
              <Select
                value={String(settings.downloadConcurrency)}
                onValueChange={(val) =>
                  handleUpdateSetting("downloadConcurrency", parseInt(val, 10))
                }
              >
                <SelectTrigger className="h-9 text-xs bg-background">
                ...
                <SelectContent>
                  ...
                  <SelectItem value="3">
                    3 videos at a time (Recommended)
                  </SelectItem>
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <Select
                ...
                onValueChange={(val) =>
                  handleUpdateSetting("globalNetworkBudget", parseInt(val, 10))
                }
              >
                <SelectTrigger className="h-9 text-xs bg-background">
                ...
                <SelectContent>
                  ...
                  <SelectItem value="18">
                    18 active requests (Recommended)
                  </SelectItem>
        ...
        <div className="flex flex-col gap-3 mt-2">
          ...
          <label className="flex items-center gap-2.5 cursor-pointer text-xs">
            <input
              ...
              onChange={(e) =>
                handleUpdateSetting("continueOnError", e.target.checked)
              }
          ...
          <label className="flex items-center gap-2.5 cursor-pointer text-xs mt-1">
            <input
              ...
              onChange={(e) =>
                handleUpdateSetting("autoStartDownloads", e.target.checked)
              }
              className="h-3.5 w-3.5 rounded border-borderAccent text-primary focus:ring-0"
            />
            <div className="flex flex-col">
