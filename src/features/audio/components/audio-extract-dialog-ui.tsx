...
export interface AudioExtractDialogViewProps {
    ...
    handleExtractFileSelect: (e: any) => void
    handleExtractFileDrop: (e: any) => void
    ...
    handleMergeVideoSelect: (e: any) => void
    handleMergeAudioSelect: (e: any) => void
    handleMergeVideoDrop: (e: any) => void
    handleMergeAudioDrop: (e: any) => void
...
export function AudioExtractDialogView(props: AudioExtractDialogViewProps) {
    const {
        open, entry, autoExtractTask, tAudioTool, tExtractAudio, tHistory, tResult,
        mode, setMode, stage, isBusy, statusPanel,
        selectedFile, extractFileInputId, handleExtractFileSelect, handleExtractFileDrop,
        handleClearExtractFile, handleExtractFile,
        mergeVideoFile, mergeAudioFile, mergeVideoInputId, mergeAudioInputId,
        handleMergeVideoSelect, handleMergeAudioSelect, handleMergeVideoDrop, handleMergeAudioDrop,
        handleClearMergeVideo, handleClearMergeAudio, handleMerge,
        handleDragOver, handleDialogOpenChange, toolbarDescription, resultTaskAction, runAutoExtractTask
    } = props;
