 ...
 */
export function calculateSegmentConcurrency(
  activeJobCount: number,
  customJobConcurrency?: number,
): number {
  ...
  const globalBudget =
    useBatchStore.getState().settings?.globalNetworkBudget ||
    DEFAULT_GLOBAL_NETWORK_BUDGET;
