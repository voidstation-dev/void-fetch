  ...
  return (
    <div className="sticky bottom-3 z-30 w-full max-w-7xl mx-auto px-2">
      <div className="border bg-card/95 backdrop-blur-2xl border-border/80 p-4 rounded-2xl shadow-2xl flex flex-col md:flex-row gap-3 items-center justify-between text-xs text-muted-foreground">
        ...
        >
          <div
            className="flex items-center gap-1.5 px-3 py-1 rounded-xl bg-muted/40 border border-border/50 text-foreground font-semibold"
            title="Total jobs"
          >
            <Layers
          ...
          <div
            className="flex items-center gap-1.5 px-3 py-1 rounded-xl bg-primary/10 border border-primary/20 text-primary font-semibold"
          ...
          <div
            className="flex items-center gap-1.5 px-3 py-1 rounded-xl bg-amber-500/10 border border-amber-500/20 text-amber-500 font-semibold"
          ...
          <div
            className="flex items-center gap-1.5 px-3 py-1 rounded-xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-500 font-semibold"
          ...
          {failed > 0 && (
            <div
              className="flex items-center gap-1.5 px-3 py-1 rounded-xl bg-destructive/10 border border-destructive/20 text-destructive font-semibold"
              title="Failed downloads"
            >
              <AlertTriangle
                className="h-3.5 w-3.5 animate-bounce-slow"
                aria-hidden="true"
              />
