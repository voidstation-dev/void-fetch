        ...
        <footer className="relative border-t border-border/80 bg-card/90 backdrop-blur-xl py-8 mt-auto overflow-hidden">
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-8 flex flex-col md:flex-row items-center justify-between gap-4">
                ...
                <div className="flex flex-wrap items-center justify-center gap-4 text-xs text-muted-foreground">
                    <Link className="hover:text-primary transition-colors font-medium" href={`/${locale}/privacy`} prefetch={false}>
                        {dict.common.privacy}
                    </Link>
                    <span>·</span>
                    <Link className="hover:text-primary transition-colors font-medium" href={`/${locale}/terms`} prefetch={false}>
                        {dict.common.terms}
                    </Link>
                    <span>·</span>
                    <Link className="hover:text-primary transition-colors font-medium" href={`/${locale}/contact`} prefetch={false}>
                        {dict.common.contact}
                    </Link>
                    <span>·</span>
                    <Link className="hover:text-primary transition-colors font-medium" href={`/${locale}/about`} prefetch={false}>
                        About
                    </Link>
                </div>
            </div>
