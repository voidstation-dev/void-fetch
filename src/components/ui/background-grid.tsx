  ...
  return (
    ...
    >
      <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
        ...
        <div className="absolute -top-40 left-1/2 -translate-x-1/2 w-[800px] h-[500px] bg-primary/10 rounded-full blur-[140px] opacity-50 dark:opacity-40" />

        {/* Radial Gradient Ambient Light Beam Bottom Right */}
        <div className="absolute -bottom-40 -right-40 w-[600px] h-[450px] bg-primary/5 rounded-full blur-[120px] opacity-40" />
