...
const explicitIndexableFlag =
  process.env.SEO_INDEXABLE ?? process.env.NEXT_PUBLIC_SEO_INDEXABLE;
...
export const SITE_URL =
  normalizeSiteUrl(process.env.NEXT_PUBLIC_SITE_URL) ?? defaultSiteUrl;
...
const PUBLIC_METADATA_COPY: Record<Locale, { description: string }> = {
  en: {
    description:
      "Free online media downloader for public video, audio, image posts, and HLS/M3U8 streams. Auto-detect supported links and download media without registration.",
  },
  zh: {
    description:
      "免费在线媒体下载工具，支持公开视频、音频、图文内容与 HLS/M3U8 串流链接识别和下载，无需注册。",
  },
  "zh-tw": {
    description:
      "免費線上媒體下載工具，支援公開影片、音訊、圖文內容與 HLS/M3U8 串流連結識別和下載，無需註冊。",
  },
  ja: {
    description:
      "公開動画、音声、画像投稿、HLS/M3U8 ストリーム向けの無料オンラインメディアダウンローダー。対応リンクを自動判別し、登録不要でダウンロードできます。",
  },
  es: {
    description:
      "Descargador online gratuito para videos publicos, audio, publicaciones con imagen y transmisiones HLS/M3U8. Detecta enlaces compatibles y descarga contenido sin registro.",
  },
  ru: {
    description:
      "Besplatnyi onlain zagruzchik media dlya publichnykh video, audio, postov s izobrazheniyami i HLS/M3U8-potokov. Avtomaticheski opredelyaet podderzhivaemye ssylki i zagruzhaet kontent bez registratsii.",
  },
  vi: {
    description:
      "Trình tải xuống phương tiện trực tuyến miễn phí cho video, âm thanh công cộng, bài đăng hình ảnh và luồng HLS/M3U8. Tự động nhận diện liên kết và tải về không cần đăng ký.",
  },
};
