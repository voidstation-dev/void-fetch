...
const cards = [
  {
    ...
    lines: [
      ...
      {
        text: "Bilibili, Douyin, Xiaohongshu, TikTok",
        x: 120,
        y: 300,
        size: 34,
        weight: 400,
      ...
      {
        text: "Parse links, download videos, extract MP3 audio",
        x: 120,
        y: 370,
        size: 28,
        weight: 400,
  ...
  },
  {
    ...
    lines: [
      ...
      {
        text: "Report issues, request features, and get support",
        x: 120,
        y: 390,
        size: 28,
        weight: 400,
  ...
  },
  {
    ...
    lines: [
      ...
      {
        text: "Data handling and user privacy commitments",
        x: 120,
        y: 390,
        size: 28,
        weight: 400,
  ...
  },
  {
    ...
    lines: [
      ...
      {
        text: "Usage rules, limits, and legal responsibilities",
        x: 120,
        y: 390,
        size: 28,
        weight: 400,
