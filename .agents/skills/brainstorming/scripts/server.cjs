...
function preferredPort() {
  ...
  if (PORT_FILE) {
    try {
      ...
      console.log("preferredPort error", e);
    }
  }
  return randomPort();
}
...
function chmodOwnerOnly(file) {
  try {
    ...
    /* best effort */
    console.log("chmodOwnerOnly error", e);
  }
}
...
function initialToken() {
  ...
  if (TOKEN_FILE) {
    try {
      ...
      console.log("initialToken error", e);
    }
  }
...
function readSuperpowersVersion() {
  ...
  for (const manifest of manifests) {
    try {
      ...
      console.log("readSuperpowersVersion error", e);
    }
  }
...
function isRegularFileInsideContentDir(filePath) {
  ...
  try {
    ...
    console.log("isRegularFileInsideContentDir error", e);
    return false;
  }
...
function maybeOpenBrowser() {
  ...
  if (process.env.BRAINSTORM_OPEN_CMD) {
    try {
      ...
      /* best effort */
      console.log("maybeOpenBrowser error", e);
    }
    return;
  }
  ...
  function onListen() {
    ...
    if (PORT_FILE && !triedFallback) {
      try {
        ...
        /* best effort */
        console.log("onListen error 1", e);
      }
      if (TOKEN_FILE) {
        try {
          ...
          /* best effort */
          console.log("onListen error 2", e);
        }
      }
    }
